...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Nn,depthTest:!1,depthWrite:!1})}function al(){return new qn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:eo(),fragmentShader:`
		...
		`,blending:Nn,depthTest:!1,depthWrite:!1})}function ll(){return new qn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:eo(),fragmentShader:`
...
void main() {
	...
	gl_FragColor = pack2HalfToRGBA( vec2( mean, std_dev ) );
                    ...
                    `}),o=new oi({color:t.color,roughness:.3,metalness:0,map:this.textureManager.watermelonTexture,bumpMap:this.textureManager.watermelonTexture,bumpScale:.03,envMapIntensity:1}),a=new Ht(n,this.textureManager.watermelonTexture?o:s);return e.add(a),e}case"orange":{const e=new qe,n=new Ve(t.radius,32,32),i=n.attributes.position.array;for(let u=0;u<i.length;u+=3){const f=i[u],g=i[u+1],v=i[u+2],m=Math.atan2(v,f),p=.02*Math.sin(m*10)*Math.sin(g*12);i[u]+=i[u]*p,i[u+1]+=i[u+1]*p,i[u+2]+=i[u+2]*p,Math.abs(g/t.radius)>.8&&(i[u+1]*=.95)}n.attributes.position.needsUpdate=!0,n.computeVertexNormals();const s=new Re({color:t.color,shininess:80,specular:8921600,map:this.textureManager.orangeTexture,bumpMap:this.textureManager.orangeTexture,bumpScale:t.bumpScale||.03,emissive:2228224,emissiveIntensity:.05}),o=new Ht(n,s);e.add(o);const a=new qe,l=new Ht(new An(t.radius*.05,t.radius*.08,t.radius*.06,8),new Re({color:8934690}));a.add(l);const c=new $s,h=t.radius*.15;c.moveTo(0,0),c.quadraticCurveTo(h*.5,h,h,0),c.quadraticCurveTo(h*.5,-h*.3,0,0);const d=new Ht(new cs(c),new Re({color:2972199,side:Be}));return d.rotation.set(Math.PI/2-.2,0,0),d.position.set(t.radius*.05,t.radius*.06,0),a.add(d),a.position.y=t.radius*.9,a.rotation.x=Math.PI*.1,e.add(a),e}case"grape":{const e=new Ve(t.radius,32,32),n=new Re({color:t.color,shininess:120,specular:8939178,map:this.textureManager.grapeTexture,bumpMap:this.textureManager.grapeTexture,bumpScale:.01});return new Ht(e,n)}default:{const e=new Ve(t.radius,32,32),n=new Re({color:t.color});return new Ht(e,n)}}}createFruitBody(t,e={x:0,y:0},n=!1){const i=t.radius;let s,o;if(t&&t.shape==="watermelon"&&t.radius>1.5)s=new bo(i,i,i*1.5,12);else if(t&&t.shape==="pumpkin"){const a=new To(i*.95);return o=new lt({mass:1,material:this.fruitMaterial,position:new y(e.x,e.y,0),linearDamping:.2,angularDamping:.4,collisionFilterGroup:n?0:1,collisionFilterMask:n?0:1,fixedRotation:!1,angularFactor:new y(.2,.2,.8)}),o.addShape(a),o.linearFactor=new y(1,1,0),o.angularFactor=new y(0,0,1),this.world.addBody(o),o.addEventListener("collide",l=>{if(!n&&window.audioManager){const c=l.contact.getImpactVelocityAlongNormal(),h=Math.min(Math.abs(c)/10,1);if(h>.1){const d=.8+Math.random()*.4;window.audioManager.playSound("hit",d,h)}}}),o}else s=new To(i);return o=new lt({mass:1,shape:s,position:new y(e.x,e.y,0),material:this.fruitMaterial,linearDamping:.1,angularDamping:.3,collisionFilterGroup:n?0:1,collisionFilterMask:n?0:1}),o.linearFactor=new y(1,1,0),o.angularFactor=new y(0,0,1),this.world.addBody(o),o.addEventListener("collide",a=>{if(!n&&window.audioManager){const l=a.contact.getImpactVelocityAlongNormal(),c=Math.min(Math.abs(l)/10,1);if(c>.1){const h=.8+Math.random()*.4;window.audioManager.playSound("hit",h,c)}}}),o}createFruit(t,e,n=!1){try{const i=this.createFruitGeometry(t);i.position.copy(e);const s=this.createFruitBody(t,e,n);return n&&i.traverse(a=>{a.isMesh&&a.material&&(a.material=a.material.clone(),a.material.transparent=!0,a.material.opacity=.7)}),this.scene&&this.scene.add(i),{mesh:i,body:s,type:t,dropTime:null}}catch(i){return console.error("Error in FruitFactory.createFruit:",i),{mesh:{position:new N(e.x,e.y,0),quaternion:new zn},body:{position:new y(e.x,e.y,0),quaternion:new ee,velocity:new y(0,0,0),angularVelocity:new y(0,0,0),type:0,addEventListener:()=>{}},type:t}}}}console.log("Development mode:",!1);const ln=[{name:"Cherry",radius:.4,color:14949143,points:1,emoji:"🍒",stemColor:4878371,shape:"cherry"},{name:"Strawberry",radius:.5,color:16719954,points:2,emoji:"🍓",leafColor:2972199,shape:"strawberry"},{name:"Grape",radius:.6,color:10040319,points:3,emoji:"🍇",shape:"grape"},{name:"Orange",radius:.65,color:16747520,points:4,emoji:"🍊",bumpScale:.05,shape:"orange"},{name:"Apple",radius:.85,color:16711680,points:5,emoji:"🍎",stemColor:4878371,shape:"apple"},{name:"Pear",radius:.95,color:16766720,points:6,emoji:"🍐",shape:"pear"},{name:"Peach",radius:1.2,color:16763812,points:7,emoji:"🍑",shape:"peach"},{name:"Pumpkin",radius:1.4,color:16741656,points:8,emoji:"🎃",stemColor:2263842,shape:"pumpkin"},{name:"Melon",radius:1.6,color:10026904,points:9,emoji:"🍈",stripeColor:2263842,shape:"melon"},{name:"Watermelon",radius:1.8,color:47917,points:10,emoji:"🍉",stripeColor:25600,shape:"watermelon"}];class Ro{constructor(){this.fruits=[],this.currentFruit=null,this.mousePosition=new gt,this.mouseDown=!1,this.gameOver=!1,this.musicPlaying=!1,this.dropCooldown=!1,this.textureManager=new Av,this.scoreManager=new Cv,this.lastDropTime=0,this.gameStarted=!1,this.animationFrameId=null,this.fruitFactory=null,this.lastTimestamp=0}init(){this.scene=new nm,this.camera=new Ge(75,window.innerWidth/window.innerHeight,.1,1e3),this.camera.position.set(0,Lt/2,7),this.camera.lookAt(0,Lt/2,0),this.setupLighting(),this.renderer=new Pl({antialias:!0}),this.renderer.setSize(window.innerWidth,window.innerHeight),this.renderer.setClearColor(1710618),document.body.appendChild(this.renderer.domElement),an.init(),this.initPhysics(),this.fruitFactory=new Rv(this.world,this.fruitMaterial,this.textureManager,this.scene),this.camera.position.set(0,Lt/2,12),this.camera.lookAt(0,Lt/2,0),this.createContainer(),this.nextFruitType=this.getRandomSmallFruit(),this.scoreManager.updateScore(0),this.raycaster=new Wm,this.mousePlane=new Xn(new N(0,0,1),0),this.intersectionPoint=new N,window.addEventListener("resize",()=>this.onWindowResize()),window.addEventListener("mousemove",t=>this.onMouseMove(t)),window.addEventListener("click",()=>this.dropFruit()),this.animate(0)}initPhysics(){this.world=new hv({gravity:new y(0,-25,0)}),this.fruitMaterial=new Wi("fruit"),this.wallMaterial=new Wi("wall");const t=new ki(this.fruitMaterial,this.wallMaterial,{friction:.35,restitution:.25});this.world.addContactMaterial(t);const e=new ki(this.fruitMaterial,this.fruitMaterial,{friction:.5,restitution:.15,contactEquationStiffness:1e6,contactEquationRelaxation:3,frictionEquationStiffness:1e6,frictionEquationRelaxation:3});this.world.addContactMaterial(e),this.world.solver.iterations=20,this.world.solver.tolerance=.001,this.createContainerWalls()}createContainerWalls(){console.log("Creating container walls");const t=this.createWall(new y(0,0,0),new y(le/2+.5,.5,.5),this.wallMaterial);t.isWall=!0;const e=this.createWall(new y(-6/2-.5,Lt/2,0),new y(.5,Lt/2,.5),this.wallMaterial);e.isWall=!0;const n=this.createWall(new y(le/2+.5,Lt/2,0),new y(.5,Lt/2,.5),this.wallMaterial);n.isWall=!0;const i=this.createWall(new y(0,Lt/2,-4/2),new y(le/2+.5,Lt/2,.5),this.wallMaterial);i.isWall=!0;const s=new lt({type:lt.STATIC,shape:new Hi(new y(le*2,.1,Ne*2)),position:new y(0,-5,0),material:this.wallMaterial,isTrigger:!0,collisionResponse:!1});s.isSensor=!0,this.world.addBody(s),this.floorSensor=s}createWall(t,e,n=this.world.defaultMaterial){const i=new Hi(e),s=new lt({mass:0,shape:i,material:n,position:t});return s.isWall=!0,this.world.addBody(s),s}setupLighting(){const t=new Hm(16777215,Sv);t.position.set(5,10,5),t.castShadow=!0,this.scene.add(t);const e=new km(16777215,Ev);this.scene.add(e);const n=new Gm(16777215,wv,15);n.position.set(0,Lt,2),this.scene.add(n);const i=new Bm(16777215,Tv);i.position.set(0,Lt+3,5),i.angle=Math.PI/4,i.penumbra=.1,i.decay=2,i.distance=20,i.target.position.set(0,Lt/2,0),this.scene.add(i),this.scene.add(i.target)}createContainer(){const n=new lt({type:lt.STATIC,material:this.wallMaterial}),i=new Hi(new y(le/2,.2,Ne/2));n.addShape(i,new y(0,0,0)),n.position.set(0,0,0),n.isWall=!0,this.world.addBody(n),this.createWall(new y(-3.2,Lt/2,0),new y(.2,Lt/2,Ne/2)),this.createWall(new y(le/2+.2,Lt/2,0),new y(.2,Lt/2,Ne/2)),this.createWall(new y(0,Lt/2,-4/2),new y(le/2+.2,Lt/2,.2)),this.createPaperBag()}createPaperBag(){const t=this.textureManager.paperTexture,e=new oi({color:vv,metalness:0,roughness:.7,map:t,side:Be,emissive:_v,emissiveIntensity:xv}),n=new Ht(new Ii(le,.1,Ne),e);n.position.set(0,.05,0),this.scene.add(n);const i=new Ht(new un(Ne,Lt),e);i.position.set(-6/2,Lt/2,0),i.rotation.y=Math.PI/2,this.scene.add(i);const s=new Ht(new un(Ne,Lt),e);s.position.set(le/2,Lt/2,0),s.rotation.y=-Math.PI/2,this.scene.add(s);const o=new Ht(new un(le,Lt),e);o.position.set(0,Lt/2,-4/2),this.scene.add(o);const a=.6,l=new Ht(new un(Ne,a),e);l.position.set(-6/2,Lt+a/2,0),l.rotation.y=Math.PI/2,l.rotation.x=Math.PI/8,this.scene.add(l);const c=new Ht(new un(Ne,a),e);c.position.set(le/2,Lt+a/2,0),c.rotation.y=-Math.PI/2,c.rotation.x=Math.PI/8,this.scene.add(c);const h=new Ht(new un(le,a),e);h.position.set(0,Lt+a/2,-4/2),h.rotation.x=Math.PI/8,this.scene.add(h);const d=(u,f,g,v,m,p)=>{const _=new Ht(new un(u,f),new Xr({color:8084284,transparent:!0,opacity:.3,side:Be}));_.position.set(g,v,m),_.rotation.y=p||0,this.scene.add(_)};d(le/2,.05,-6/4,Lt/2,-4/2+.01),d(le/2,.05,le/4,Lt/2,-4/2+.01),d(Ne/2,.05,-6/2-.01,Lt/2,-4/4,Math.PI/2),d(Ne/2,.05,-6/2-.01,Lt/2,Ne/4,Math.PI/2),d(Ne/2,.05,le/2+.01,Lt/2,-4/4,Math.PI/2),d(Ne/2,.05,le/2+.01,Lt/2,Ne/4,Math.PI/2)}getRandomSmallFruit(){return ln[Math.floor(Math.random()*3)]}updateScore(t){this.scoreManager.updateScore(t)}createFruitGeometry(t){switch(t.shape){case"cherry":return this.fruitFactory.createFruitGeometry(t);case"strawberry":return this.fruitFactory.createFruitGeometry(t);case"orange":return this.fruitFactory.createFruitGeometry(t);case"watermelon":return this.fruitFactory.createFruitGeometry(t);case"grape":return this.fruitFactory.createFruitGeometry(t);case"apple":return this.fruitFactory.createFruitGeometry(t);case"pear":return this.fruitFactory.createFruitGeometry(t);case"peach":return this.fruitFactory.createFruitGeometry(t);case"pineapple":return this.fruitFactory.createFruitGeometry(t);case"melon":return this.fruitFactory.createFruitGeometry(t);case"pumpkin":return this.fruitFactory.createFruitGeometry(t);default:{const e=new Ve(t.radius,32,32),n=new Re({color:t.color});return new Ht(e,n)}}}createFruitBody(t,e,n=!1,i){this.world||(console.log("World not initialized, initializing physics first"),this.initPhysics());let s,o;if(i&&i.shape==="watermelon"&&i.radius>1.5)s=new bo(t,t,t*1.5,12);else if(i&&i.shape==="pineapple"){s=new bo(t*.7,t*.7,t*2.4,10);const a=new ee;a.setFromAxisAngle(new y(1,0,0),Math.PI/2),s.transformAllPoints(new y,a)}else s=new To(t);return this.world?(o=new lt({mass:1,shape:s,position:new y(e.x,e.y,0),material:this.fruitMaterial,linearDamping:.1,angularDamping:.05,collisionFilterGroup:n?0:1,collisionFilterMask:n?0:1}),o.lastCollisionTime=0,o.collisionCooldown=100,o.addEventListener("collide",a=>{if(!this.world)return;o.velocity.z=0,o.position.z=0;const l=Date.now();a.body&&a.body.material===this.wallMaterial&&l-o.lastCollisionTime>o.collisionCooldown&&(typeof an<"u"&&an&&an.playSound("hit"),o.lastCollisionTime=l)}),this.world.addBody(o),o):(console.error("Failed to create physics body - world is null"),{position:new y(e.x,e.y,0),quaternion:new ee,velocity:new y(0,0,0),angularVelocity:new y(0,0,0),type:0,addEventListener:()=>{},fixedRotation:!1,updateMassProperties:()=>{}})}createFruit(t,e,n=!1){if(!this.scene)return console.error("Scene is not initialized - cannot create fruit"),{mesh:{position:e,quaternion:new zn},body:{position:new y(e.x,e.y,0),quaternion:new ee,velocity:new y(0,0,0),angularVelocity:new y(0,0,0),type:0,addEventListener:()=>{}},type:t};try{const i=this.createFruitGeometry(t);i.position.copy(e);const s=this.createFruitBody(t.radius,e,n,t);n&&i.traverse(a=>{a.isMesh&&a.material&&(a.material=a.material.clone(),a.material.transparent=!0,a.material.opacity=.7)}),this.scene&&this.scene.add(i);const o={mesh:i,body:s,type:t,dropTime:null};return n||this.fruits.push(o),o}catch(i){return console.error("Error creating fruit:",i),{mesh:{position:e,quaternion:new zn},body:{position:new y(e.x,e.y,0),quaternion:new ee,velocity:new y(0,0,0),angularVelocity:new y(0,0,0),type:0,addEventListener:()=>{}},type:t}}}checkFruitCombinations(){for(let t=0;t<this.fruits.length;t++)for(let e=t+1;e<this.fruits.length;e++){const n=this.fruits[t],i=this.fruits[e];if(!n||!i||n.type.name!==i.type.name)continue;if(n.body.position.distanceTo(i.body.position)<n.type.radius+i.type.radius){const o=ln.indexOf(n.type)+1;if(o<ln.length){const a=new N((n.body.position.x+i.body.position.x)/2,(n.body.position.y+i.body.position.y)/2,0),l=new y;return l.x=(n.body.velocity.x+i.body.velocity.x)/2,l.y=(n.body.velocity.y+i.body.velocity.y)/2,l.z=0,this.removeFruit(n),this.removeFruit(i),this.createFruit(ln[o],a).body.velocity.copy(l),an.playSound("merge"),this.scoreManager.addPoints(ln[o].points),this.fruits.length>1?this.checkFruitCombinations():void 0}}}}checkGameOver(){const t=this.fruits.some(n=>n.body.position.y>Lt-1&&n.body.velocity.length()<.2&&Date.now()-this.lastDropTime>1e3),e=this.fruits.some(n=>n.body.position.y<-2||n.body.position.y<0&&Math.abs(n.body.position.x)>le/2+.5);(t||e)&&!this.gameOver&&(this.gameOver=!0,console.log("Game over triggered"),e&&console.log("Game over caused by fruit falling out of container"),this.showGameOverScreen())}showGameOverScreen(){const t=document.createElement("div");t.style.position="absolute",t.style.top="50%",t.style.left="50%",t.style.transform="translate(-50%, -50%)",t.style.color="white",t.style.fontSize="36px",t.style.textAlign="center",t.style.backgroundColor="rgba(0, 0, 0, 0.8)",t.style.padding="20px",t.style.borderRadius="10px",t.style.zIndex="1000";const e=document.createElement("button");e.id="restart-button",e.innerText="Play Again",e.style.padding="10px 20px",e.style.marginTop="20px",e.style.cursor="pointer",e.style.fontSize="18px",e.style.backgroundColor="#4CAF50",e.style.color="white",e.style.border="none",e.style.borderRadius="5px";const n=document.createElement("div");n.innerText="Game Over";const i=document.createElement("div");i.innerText=`Final Score: ${this.scoreManager.getCurrentScore()}`,i.style.fontSize="24px";const s=document.createElement("div");s.innerText=`High Score: ${this.scoreManager.getHighScore()}`,s.style.fontSize="20px",t.appendChild(n),t.appendChild(i),t.appendChild(s),t.appendChild(e),document.body.appendChild(t),e.addEventListener("click",function(){console.log("Restart button clicked"),t&&t.parentNode&&document.body.removeChild(t);const o=ce.scoreManager.getHighScore(),a=an.musicPlaying;ce.dispose(),ce=new Ro,ce.init(),ce.scoreManager.setHighScore(o),ce.animate(0),a&&an.playBackgroundMusic(),console.log("New game instance created with high score:",o)})}preventBottomClipping(){for(const t of this.fruits)if(t.body&&t.body.position.y<.5&&t.body.velocity.y<=.1){const n=.05+Math.max(0,.5-t.body.position.y)*.2;t.body.applyForce(new y(0,n,0),t.body.position),t.body.position.y<.05&&(t.body.position.y=.05,t.body.velocity.y<0&&(t.body.velocity.y=0))}}stabilizeStackedFruits(){for(const t of this.fruits){if(!t.body||t.dropTime&&Date.now()-t.dropTime<2e3)continue;const e=t.body.velocity.length(),n=t.body.angularVelocity.length();let i=0,s=!1,o=!1;if(t.body.world&&t.body.world.contacts)for(let a=0;a<t.body.world.contacts.length;a++){const l=t.body.world.contacts[a];if(l.bi===t.body||l.bj===t.body){i++,l.bi===t.body?l.bj:l.bi;const c=l.ni.y;c>.7?s=!0:Math.abs(c)<.3&&(o=!0)}}e<.3&&s&&o&&i>=3&&(t.body.linearDamping=.9,t.body.angularDamping=.9,e>.1&&t.body.velocity.scale(.9,t.body.velocity),n>.3&&t.body.angularVelocity.scale(.8,t.body.angularVelocity),t.body.position.y<Lt/4&&Date.now()-t.dropTime>5e3&&i>4&&(t.body.velocity.scale(.5,t.body.velocity),t.body.angularVelocity.scale(.5,t.body.angularVelocity)))}}dispose(){console.log("Disposing game resources"),this.animationFrameId&&(cancelAnimationFrame(this.animationFrameId),this.animationFrameId=null),window.removeEventListener("mousemove",this.onMouseMoveBound),document.removeEventListener("keydown",this.keyDownHandler),document.removeEventListener("click",this.clickHandler),window.removeEventListener("resize",this.onWindowResizeBound),this.scene&&this.scene.traverse(t=>{t.geometry&&t.geometry.dispose(),t.material&&(Array.isArray(t.material)?t.material.forEach(e=>{e.map&&e.map.dispose(),e.dispose()}):(t.material.map&&t.material.map.dispose(),t.material.dispose()))}),this.renderer&&(this.renderer.dispose(),document.body.removeChild(this.renderer.domElement)),this.fruits=[],this.currentFruit=null}removeFruit(t){this.scene.remove(t.mesh),this.world.removeBody(t.body),this.fruits=this.fruits.filter(e=>e!==t)}spawnSpecificFruit(t,e=0,n=null){if(this.gameOver)return;if(n===null&&(n=Lt+1),t<0||t>=ln.length){console.error(`Invalid fruit index: ${t}. Must be between 0 and ${ln.length-1}`);return}const i=ln[t],s=new N(e,n,0),o=this.fruitFactory.createFruit(i,s,!1);return o.body.type=lt.DYNAMIC,o.body.collisionFilterGroup=1,o.body.collisionFilterMask=1,o.body.angularDamping=.1,o.dropTime=Date.now(),o.mesh&&typeof o.mesh.traverse=="function"&&o.mesh.traverse(a=>{a.isMesh&&a.material&&(a.material=a.material.clone(),a.material.opacity=1)}),o.body.velocity.set(0,-1,0),o.body.angularVelocity.set(0,0,(Math.random()-.5)*5),o.body.fixedRotation=!1,typeof o.body.updateMassProperties=="function"&&o.body.updateMassProperties(),this.fruits.push(o),o}initDebugPanel(){const t=document.createElement("div");t.id="debug-panel",t.style.position="fixed",t.style.top="10px",t.style.right="10px",t.style.backgroundColor="rgba(0, 0, 0, 0.7)",t.style.color="white",t.style.padding="10px",t.style.borderRadius="5px",t.style.zIndex="1000",t.style.maxHeight="80vh",t.style.overflowY="auto",t.style.display="none";const e=document.createElement("button");e.id="debug-toggle-button",e.textContent="🛠️ Debug",e.style.position="fixed",e.style.top="10px",e.style.right="10px",e.style.zIndex="1001",e.style.padding="5px 10px",e.style.borderRadius="5px",e.style.backgroundColor="#333",e.style.color="white",e.style.border="1px solid #555";const n=document.createElement("h3");n.textContent="Fruit Spawner",n.style.margin="0 0 10px 0",t.appendChild(n);const i=document.createElement("div");i.style.display="grid",i.style.gridTemplateColumns="repeat(2, 1fr)",i.style.gap="5px",t.appendChild(i),ln.forEach((u,f)=>{const g=document.createElement("button");g.textContent=`${u.emoji} ${u.name}`,g.style.padding="5px",g.style.margin="2px",g.style.backgroundColor="#444",g.style.color="white",g.style.border="1px solid #666",g.style.borderRadius="3px",g.style.cursor="pointer",g.onmouseover=()=>{g.style.backgroundColor="#555"},g.onmouseout=()=>{g.style.backgroundColor="#444"},g.onclick=()=>{let v=0;if(ce.intersectionPoint){const m=u.radius,p=le/2-m;v=Math.max(-p,Math.min(p,ce.intersectionPoint.x))}ce.spawnSpecificFruit(f,v)},i.appendChild(g)});const s=document.createElement("div");s.style.marginTop="10px",s.style.padding="5px",s.style.backgroundColor="#333",s.style.borderRadius="3px";const o=document.createElement("div");o.textContent="Spawn Multiple:",o.style.marginBottom="5px",s.appendChild(o);const a=document.createElement("div");a.style.display="flex",a.style.alignItems="center",a.style.marginBottom="5px";const l=document.createElement("label");l.textContent="Quantity: ",l.style.marginRight="5px";const c=document.createElement("input");c.type="number",c.min="1",c.max="10",c.value="1",c.style.width="50px",a.appendChild(l),a.appendChild(c),s.appendChild(a);const h=document.createElement("button");h.textContent="🎲 Spawn Random Assortment",h.style.width="100%",h.style.padding="5px",h.style.marginTop="5px",h.style.backgroundColor="#444",h.style.color="white",h.style.border="1px solid #666",h.style.borderRadius="3px",h.style.cursor="pointer",h.onclick=()=>{const u=parseInt(c.value)||1,f=10;for(let g=0;g<Math.min(u,f);g++){const v=Math.min(Math.floor(Math.random()*5),ln.length-1),m=ln[v].radius,p=le/2-m,_=Math.random()*p*2-p,x=Lt*.5+Math.random()*Lt*.5;setTimeout(()=>{ce.spawnSpecificFruit(v,_,x)},g*100)}},s.appendChild(h),t.appendChild(s);const d=document.createElement("button");d.textContent="🧹 Clear All Fruits",d.style.width="100%",d.style.padding="5px",d.style.marginTop="10px",d.style.backgroundColor="#a33",d.style.color="white",d.style.border="1px solid #c44",d.style.borderRadius="3px",d.style.cursor="pointer",d.onclick=()=>{for(;ce.fruits.length>0;){const u=ce.fruits.pop();ce.removeFruit(u)}ce.currentFruit&&(ce.removeFruit(ce.currentFruit),ce.currentFruit=null,ce.spawnFruit())},t.appendChild(d),e.addEventListener("click",()=>{const u=t.style.display!=="none";t.style.display=u?"none":"block",e.textContent=u?"🛠️ Debug":"❌ Close",e.style.backgroundColor=u?"#333":"#a33"}),document.body.appendChild(e),document.body.appendChild(t)}onMouseMove(t){if(this.gameOver)return;this.mousePosition.x=t.clientX/window.innerWidth*2-1,this.mousePosition.y=-(t.clientY/window.innerHeight*2-1),this.raycaster.setFromCamera(this.mousePosition,this.camera),this.raycaster.ray.intersectPlane(this.mousePlane,this.intersectionPoint);const e=this.nextFruitType?this.nextFruitType.radius:.5,n=le/2-e,i=Math.max(-n,Math.min(n,this.intersectionPoint.x));if(this.currentFruit)this.currentFruit.mesh.position.x=i,this.currentFruit.body.position.x=i,this.currentFruit.mesh.position.y=Lt+1,this.currentFruit.mesh.position.z=0,this.currentFruit.body.position.y=Lt+1,this.currentFruit.body.position.z=0;else{const s=new N(i,Lt+1,0);this.currentFruit=this.fruitFactory.createFruit(this.nextFruitType,s,!0),this.currentFruit.body.type=lt.KINEMATIC,this.currentFruit.body.velocity.set(0,0,0),this.currentFruit.body.angularVelocity.set(0,0,0)}}dropFruit(){if(!this.gameOver&&!this.dropCooldown&&this.currentFruit){if(this.dropCooldown=!0,setTimeout(()=>{this.dropCooldown=!1},200),!this.currentFruit.body){console.error("Current fruit body is null or undefined"),this.currentFruit=null,setTimeout(()=>this.spawnFruit(),300);return}try{if(this.currentFruit.body.type=lt.DYNAMIC,this.currentFruit.body.collisionFilterGroup=1,this.currentFruit.body.collisionFilterMask=1,this.currentFruit.body.angularDamping=.1,this.currentFruit.dropTime=Date.now(),this.currentFruit.mesh&&typeof this.currentFruit.mesh.traverse=="function"?this.currentFruit.mesh.traverse(t=>{t.isMesh&&t.material&&(t.material=t.material.clone(),t.material.opacity=1)}):this.currentFruit.mesh&&this.currentFruit.mesh.material&&(this.currentFruit.mesh.material.opacity=1),this.currentFruit.body.position.z=0,this.currentFruit.mesh&&this.currentFruit.mesh.position&&(this.currentFruit.mesh.position.z=0),this.currentFruit.body.velocity.set(0,-1,0),this.currentFruit.body.angularVelocity.set(0,0,(Math.random()-.5)*10),this.currentFruit.body.fixedRotation=!1,typeof this.currentFruit.body.updateMassProperties=="function"&&this.currentFruit.body.updateMassProperties(),an){const t=1+(Math.random()*.2-.1);an.playSound("drop",t)}this.fruits.push(this.currentFruit),this.currentFruit=null,setTimeout(()=>{this.spawnFruit()},300)}catch(t){console.error("Error dropping fruit:",t),this.currentFruit=null,setTimeout(()=>this.spawnFruit(),300)}}}onWindowResize(){this.gameOver||(this.camera.aspect=window.innerWidth/window.innerHeight,this.camera.updateProjectionMatrix(),this.renderer.setSize(window.innerWidth,window.innerHeight))}animate(t){if(this.gameOver)return;this.animationFrameId=requestAnimationFrame(n=>this.animate(n)),this.lastTimestamp||(this.lastTimestamp=t||0);const e=t?Math.min((t-this.lastTimestamp)/1e3,.1):1/60;if(this.lastTimestamp=t||0,this.world){this.world.step(.016666666666666666,e,3);for(const s of this.fruits)s.body.position.z!==0&&(s.body.position.z=0,s.mesh.position.z=0),s.body.velocity.z!==0&&(s.body.velocity.z=0);for(const s of this.fruits)s.body&&s.mesh&&(s.mesh.position.copy(s.body.position),s.mesh.quaternion.copy(s.body.quaternion))}this.checkFruitCombinations(),this.checkGameOver(),this.preventBottomClipping(),this.stabilizeStackedFruits(),this.renderer.render(this.scene,this.camera)}generateNextFruit(){this.nextFruitType=this.getRandomSmallFruit();const t=document.getElementById("next-fruit");if(t){for(;t.firstChild;)t.removeChild(t.firstChild);t.textContent=`Next: ${this.nextFruitType.name}`}}spawnFruit(){if(this.gameOver||this.currentFruit)return;this.nextFruitType||this.generateNextFruit();let t=0;if(this.intersectionPoint){const n=this.nextFruitType?this.nextFruitType.radius:.5,i=le/2-n;t=Math.max(-i,Math.min(i,this.intersectionPoint.x))}const e=new N(t,Lt+1,0);this.currentFruit=this.fruitFactory.createFruit(this.nextFruitType,e,!0),this.currentFruit.body.type=lt.KINEMATIC,this.currentFruit.body.velocity.set(0,0,0),this.currentFruit.body.angularVelocity.set(0,0,0),this.generateNextFruit()}}let ce;document.addEventListener("DOMContentLoaded",()=>{const r=document.createElement("button");r.textContent="🎵 Play!",r.style.position="absolute",r.style.top="50%",r.style.left="50%",r.style.transform="translate(-50%, -50%)",r.style.zIndex="10000",r.style.padding="20px 30px",r.style.fontSize="24px",r.style.backgroundColor="#4CAF50",r.style.color="white",r.style.border="none",r.style.borderRadius="8px",r.style.cursor="pointer",r.style.boxShadow="0 4px 8px rgba(0, 0, 0, 0.3)",r.addEventListener("click",()=>{an.init(),an.playBackgroundMusic(),document.body.removeChild(r),ce||(ce=new Ro,ce.init(),ce.animate(0))}),document.body.appendChild(r)})})();
